...
public class KakaoPlacesController {
    ...
    private TourPlace convertKakaoPlaceToTourPlace(SearchKakaoPlacesFunction.KakaoPlace kakaoPlace, String clusterName, int placeIndex) {
        ...
        return TourPlace.builder()
            .externalId("kakao_" + System.currentTimeMillis() + "_" + kakaoPlace.getName().hashCode())
            .name(kakaoPlace.getName())
            .address(kakaoPlace.getAddress())
            .operatingHours(operatingHours)
            .overview("Kakao Places API에서 제공하는 장소 정보")
            .rating(getDefaultRatingByCategory(mappedCategory))

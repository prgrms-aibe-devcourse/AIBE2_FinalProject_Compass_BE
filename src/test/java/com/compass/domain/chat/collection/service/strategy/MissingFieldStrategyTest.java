...
class MissingFieldStrategyTest {
    ...
    void findNextQuestion_shouldAskForDestination_whenItIsUndecided() {
        // given
        // ✅ 수정: 생성자에 null 2개 추가
        var info = new TravelFormSubmitRequest(null, List.of("목적지 미정"), null, null, null, null, null, null, null, null);
    ...
    void findNextQuestion_shouldAskForDates_whenDestinationIsPresentButDatesAreMissing() {
        // given
        // ✅ 수정: 생성자에 null 2개 추가
        var info = new TravelFormSubmitRequest(null, List.of("부산"), null, null, null, null, null, null, null, null);
    ...
    void findNextQuestion_shouldAskForDeparture_whenDatesArePresentButDepartureIsMissing() {
        ...
        // ✅ 수정: 생성자에 null 2개 추가
        var info = new TravelFormSubmitRequest(null, List.of("서울"), null, dateRange, null, null, null, null, null, null);
    ...
    void findNextQuestion_shouldReturnEmpty_whenAllRequiredInfoIsPresent() {
        ...
        var dateRange = new TravelFormSubmitRequest.DateRange(LocalDate.now(), LocalDate.now().plusDays(1));
        // ✅ 수정: 생성자에 null 2개 추가
        var info = new TravelFormSubmitRequest(null, List.of("제주"), "서울", dateRange, null, null, null, null, null, null);
